...
module.exports = (app, rutaMovimientos) => {
    ...
    app.route(rutaMovimientos)
        .get((req, res) => {
            ...
            mongodb.finding(collection, { usuario: req.usuario })
    ...
    app.route(`${rutaMovimientos}/:id`)
        ...
        .delete((req, res) => {
            ...
            mongodb.deleting(collection, { usuario: req.usuario }, req.params.id)
