...
function existeUsuario(usuario) {
    return mongodb.finding(collection, { email: usuario.email })
}

function creandoUsuario(usuario) {
    return mongodb.inserting(collection, usuario)
}

function esUsuarioValido(usuario) {
    return mongodb.finding(collection, { email: usuario.email, password: usuario.password })
}